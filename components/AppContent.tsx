...
export function AppContent() {
  return (
    <div className="main-content app-content">
      <Section id="die-national-casino-app-in-deutschland" title="Die National Casino App in Deutschland">
      ...
      <Section id="ein-klares-wort-zu-apk-dateien" title="Ein klares Wort zu APK-Dateien">
      ...
      <Section id="was-du-davon-hast" title="Was du davon hast">
        ...
        <h3>Sie ist wirklich tragbar</h3>
        ...
        <h3>Sie ist von Grund auf sicherer</h3>
        ...
        <h3>Sie ist für den Bildschirm gebaut, den du in der Hand hältst</h3>
      ...
      <Section id="verantwortungsvoll-spielen" title="Verantwortungsvoll spielen">
