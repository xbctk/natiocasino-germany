...
function SectionCta({ type }: { type: "bonus" | "join" }) {
  const isBonus = type === "bonus";
  return (
    <a
      className="button button--primary content-section__action"
      href={isBonus ? BONUS_AFFILIATE_URL : GENERAL_AFFILIATE_URL}
      rel="sponsored"
    >
      {isBonus ? "Bonus Holen" : "Jetzt beitreten"}
    </a>
  );
}
    ...
    <div className="main-content bonuses-content boni-page-content">
      ...
      <Section id="treuebelohnungen-vip" title="Treuebelohnungen & VIP-Vorteile" className="image-copy-section image-copy-section--wide-title boni-vip-section">
        ...
        <div className="image-copy-section__copy">
          ...
          <h3 className="boni-icon-heading boni-icon-heading--fire">Wie du verdienst</h3>
          ...
          <h3 className="boni-icon-heading boni-icon-heading--fire">Die Stufen und was sie wert sind</h3>
      ...
      <Section id="mehr-wege-zum-wert" title="Mehr Wege, auf denen der Wert zurückkommt">
        ...
        <div className="boni-event-art-frame" aria-hidden="true">
      ...
      <Section id="turniere-bestenlisten" title="Turniere und Bestenlisten" className="image-copy-section image-copy-section--wide-title boni-tournament-section">
        ...
        <div className="image-copy-section__copy">
          ...
          <h3 className="boni-icon-heading boni-icon-heading--cards">Was läuft</h3>
          ...
          <h3 className="boni-icon-heading boni-icon-heading--cards">Wie du mitmachst</h3>
