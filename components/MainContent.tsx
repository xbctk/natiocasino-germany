...
export function MainContent() {
  return (
    <div className="main-content">
      <Section id="national-casino-spielsaal" title="National Casino: Ein Spielsaal, der seine Karten offenlegt">
      ...
      <Section id="was-diesen-spielsaal-auszeichnet" title="Was diesen Spielsaal auszeichnet">
      ...
      <Section id="technisches-bild" title="Das technische Bild auf einen Blick">
      ...
      <Section id="lobby-landkarte" title="Die Lobby wie eine Landkarte lesen">
      ...
      <Section id="zahlen-auf-der-kachel" title="Die Zahlen auf der Kachel">
      ...
      <Section id="spielkachel-lesen" title="Wie man eine Spielkachel im National Casino liest">
      ...
      <Section id="slots-mit-zahlen" title="Die Slots, mit ihren Zahlen">
      ...
      <Section id="anbieter" title="Die Anbieter hinter dem Spielsaal">
      ...
      <Section id="live-etage" title="Die Live-Etage">
      ...
      <Section id="boni-und-aktionen" title="Boni und Aktionen">
      ...
      <Section id="vip-aufstieg" title="Der VIP-Aufstieg">
      ...
      <Section id="turniere" title="Turniere">
      ...
      <Section id="registrierung-und-anmeldung" title="Loslegen: Registrierung und Anmeldung">
      ...
      <Section id="spielen-am-handy" title="Spielen am Handy">
      ...
      <Section id="zahlungen-und-support" title="Einzahlungen, Auszahlungen und Support">
      ...
      <Section id="verantwortungsvolles-spielen" title="Ein Wort zum verantwortungsvollen Spielen">
      ...
      <Section id="spielermeinungen" title="Was Spieler tatsächlich sagen">
        <p>Sechs Stammgäste, in ihren eigenen Worten.</p>
        <p>„Ich kam für den Krypto-Bonus und blieb wegen des Rads.&quot; Habe mich rein deshalb angemeldet, weil das 200-%-Krypto-Match besser war als überall sonst, wo ich in der Woche geschaut hatte — ich bin ehrlich, das war der ganze Grund. Dachte, ich nehme den Bonus und gehe. Dann fand ich die Spielshow-Tische und verlor einen ganzen Sonntag an Crazy Time, was ich nicht eingeplant hatte. Die Auszahlung dauerte einen Tag länger, als mir lieb war, aber sie kam einwandfrei an. Ich bin drei Monate später immer noch hier, hauptsächlich wegen des Rads. Das habe ich nicht kommen sehen. — Marcus</p>
        <p>„Die RTP-Sache hat neu verdrahtet, wie ich spiele.&quot; Früher habe ich einfach geklickt, was glänzte. Jetzt prüfe ich tatsächlich zuerst die Zahl auf der Kachel, was nerdig klingt und es wahrscheinlich auch ist. Heißt nicht, dass ich mehr gewinne — ich weiß, dass es so nicht funktioniert, mein Verstand weiß es, meine Brieftasche vergisst es gelegentlich — aber ich habe das Gefühl, klüger zu spielen, und ehrlich, dieses Gefühl ist die halbe Miete, warum ich das tue. Seltsamerweise hat mich die Transparenz ein bisschen weniger spielen lassen, nicht mehr. — Priya</p>
        <p>„Toller Spielsaal, ein Ärgernis.&quot; Alles am eigentlichen Spielen ist hervorragend. Riesige Blackjack-Auswahl, die Dealer sind auf Zack, kein Live-Tisch ist mir je eingefroren. Meine eine Beschwerde, und die bringe ich jedes Mal vor: Ich zahle in Bitcoin ein und muss dann auf meine Karte auszahlen. Warum. Lasst es mich einfach so herausnehmen, wie ich es hineingesteckt habe. Kleinigkeit. Logge mich trotzdem heute Abend ein. — Tom</p>
        <p>„Ich verstehe den RTP nicht mal wirklich, aber ich mag, dass er da ist.&quot; Mein Sohn hat es mir zweimal erklärt, und ich könnte dir immer noch nicht genau sagen, was 138 % bedeutet, irgendwas mit jüngsten Auszahlungen, sagte er. Aber ich mag einen Ort, der einem Dinge zeigt, statt sie zu verstecken. Fühlt sich ehrlich an. Ich spiele meist den Frosch-Slot mit der Elvis-Musik, der mich jedes Mal zum Lachen bringt, und die Sonntags-Spins sind mehr wert als die Freispiele, die ich irgendwo sonst bekomme. — Eleanor</p>
        <p>„Die Turniere haben mich erwischt, und ich bin nicht stolz darauf.&quot; Fing mit den Treasure Races als Scherz an, weil ich den kleinen Countdown-Timer mochte. Jetzt prüfe ich morgens, wo ich auf der Bestenliste stehe, bevor ich meine E-Mails prüfe. Es sind dieselben Spins, die ich ohnehin machen würde, das rede ich mir jedenfalls ein, aber da ist etwas am Gerankt-Sein, das einen gewöhnlichen Dienstagabend wichtig anfühlen lässt. Die 300 Freispiele schaden auch nicht. — Dani</p>
        <p>„Tiefer Katalog, hat eine Weile gedauert, meine Ecke zu finden.&quot; In der ersten Woche war ich überfordert — es ist einfach viel davon, und ich sprang herum, ohne wirklich irgendwo zu landen. Dann fand ich das Hold-&amp;-Win-Regal und ging im Grunde nie wieder weg. Auf genau die Studios filtern zu können, denen ich vertraue, ist die Sache, die es für mich klick machen ließ. Der Support beantwortete eine Zahlungsfrage zu einer unchristlichen Stunde und war tatsächlich hilfreich, was ich gelernt habe, nicht als selbstverständlich zu nehmen. Solider Ort, sobald du deine Ecke davon gefunden hast. — Kwame</p>
      </Section>

      <Section id="bewertungskarte" title="Die Bewertungskarte">
        <div className="table-scroll" role="region" tabIndex={0}>
          <table>
            <thead><tr>
      ...
      <Section id="letztes-wort" title="Das letzte Wort">
        ...
        <p>— Bewertet von Daniel Roche, Chefredakteur iGaming</p>
      </Section>
    </div>
  );
}
