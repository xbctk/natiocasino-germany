...
const germanPlayerReviews = [
  { review: "„Ich kam für den Krypto-Bonus und blieb wegen des Rads.\" Habe mich rein deshalb angemeldet, weil das 200-%-Krypto-Match besser war als überall sonst, wo ich in der Woche geschaut hatte — ich bin ehrlich, das war der ganze Grund. Dachte, ich nehme den Bonus und gehe. Dann fand ich die Spielshow-Tische und verlor einen ganzen Sonntag an Crazy Time, was ich nicht eingeplant hatte. Die Auszahlung dauerte einen Tag länger, als mir lieb war, aber sie kam einwandfrei an. Ich bin drei Monate später immer noch hier, hauptsächlich wegen des Rads. Das habe ich nicht kommen sehen. — Marcus" },
  { review: "„Die RTP-Sache hat neu verdrahtet, wie ich spiele.\" Früher habe ich einfach geklickt, was glänzte. Jetzt prüfe ich tatsächlich zuerst die Zahl auf der Kachel, was nerdig klingt und es wahrscheinlich auch ist. Heißt nicht, dass ich mehr gewinne — ich weiß, dass es so nicht funktioniert, mein Verstand weiß es, meine Brieftasche vergisst es gelegentlich — aber ich habe das Gefühl, klüger zu spielen, und ehrlich, dieses Gefühl ist die halbe Miete, warum ich das tue. Seltsamerweise hat mich die Transparenz ein bisschen weniger spielen lassen, nicht mehr. — Priya" },
  { review: "„Toller Spielsaal, ein Ärgernis.\" Alles am eigentlichen Spielen ist hervorragend. Riesige Blackjack-Auswahl, die Dealer sind auf Zack, kein Live-Tisch ist mir je eingefroren. Meine eine Beschwerde, und die bringe ich jedes Mal vor: Ich zahle in Bitcoin ein und muss dann auf meine Karte auszahlen. Warum. Lasst es mich einfach so herausnehmen, wie ich es hineingesteckt habe. Kleinigkeit. Logge mich trotzdem heute Abend ein. — Tom" },
